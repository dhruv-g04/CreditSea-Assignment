    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                mongoURI = ((_a = process.env.MONGO_URI) === null || _a === void 0 ? void 0 : _a.trim()) || "mongodb://localhost:27017/Loans";
            ...
            case 2:
                // Attempt to connect to the MongoDB database
                _b.sent(); // No additional options needed
                console.log('Successfully connected to MongoDB:', mongoURI);
                return [3 /*break*/, 4];
            case 3:
                err_1 = _b.sent();
                console.error('Failed to connect to MongoDB:', err_1.message);
